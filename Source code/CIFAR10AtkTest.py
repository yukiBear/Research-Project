# -*- coding: utf-8 -*-
"""
Created on Sat May 15 16:31:08 2021

@author: LENOVO
"""
"""
Help function for attack generation
Part of the parameters are droped and to be explored later
"""
from CIFAR10_SampleGenerator import SampleGenerator
import time
...
def GenerateSamples(feature_extracter, model_under_attack, seeds, labels, mode,
    ...
    for i in range(0, len(seeds)):
        attackGenerator = SampleGenerator(feature_extracter, model_under_attack)
